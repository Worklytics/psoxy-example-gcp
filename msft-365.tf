...
module "worklytics_connectors_msft_365" {
  source = "git::https://github.com/worklytics/psoxy//infra/modules/worklytics-connectors-msft-365?ref=v0.4.37"
...
module "msft-connection-auth-federation" {
  ...
  source = "git::https://github.com/worklytics/psoxy//infra/modules/azuread-federated-credentials?ref=v0.4.37"
